...
trait SponsoredProductsRequests
{
    ...
    {
        return $this->operation("sp/targets/" . $targetId, null, 'DELETE');
    }
    ...
    {
        return $this->operation("sp/negativeTargets/" . $targetId, null, 'DELETE');
    }
    ...
    {
        return $this->operation("sp/campaignNegativeTargets/" . $targetId, null, 'DELETE');
    }
}
