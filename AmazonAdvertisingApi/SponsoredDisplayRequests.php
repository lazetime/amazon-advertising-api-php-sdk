...
trait SponsoredDisplayRequests
{
    ...
    {
        return $this->operation("sd/campaigns/{$campaignId}", null, "DELETE");
    }
    ...
    {
        return $this->operation("sd/adGroups/{$adGroupId}", null, "DELETE");
    }
    ...
    {
        return $this->operation("sd/productAds/{$adId}", null, "DELETE");
    }
    ...
    {
        return $this->operation("sd/targets/{$targetId}", null, "DELETE");
    }
    ...
    {
        return $this->operation("sd/negativeTargets/{$negativeTargetId}", null, "DELETE");
    }
